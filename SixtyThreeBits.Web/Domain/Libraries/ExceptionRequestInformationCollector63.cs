...
{
	public class ExceptionRequestInformationCollector63
	{
		#region Properties
		...
		#region Constructors
		ExceptionRequestInformationCollector63(HttpRequest request, Exception exception)
		{
			_request = request;
			_ex = exception;
		}
		...
		#region Methods
		public static ExceptionRequestInformationCollector63 Create(HttpRequest request, Exception exception)
		{
			return new ExceptionRequestInformationCollector63(request, exception);
		}
