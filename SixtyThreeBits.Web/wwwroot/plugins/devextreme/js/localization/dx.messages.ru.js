...
(function(root, factory) {
    ...
    localization.loadMessages({
        "ru": {
            ...
            "dxDataGrid-aiAssistantTitle": "Помощник ИИ",
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Запрос выполняется",
            "dxDataGrid-aiAssistantProcessingMessage": "Обработка...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "Не удалось обработать запрос",
            "dxDataGrid-aiAssistantAbortMessage": "Запрос остановлен.",
            "dxDataGrid-aiAssistantSuccessMessage": "Успешно",
            "dxDataGrid-aiAssistantErrorMessage": "Ошибка",
            "dxDataGrid-aiAssistantExecutionAbortMessage": "Выполнение прервано",
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "Операция уже выполняется. Подождите.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "Запрос уже выполняется. Подождите.",
            "dxDataGrid-aiAssistantUnexpectedErrorMessage": "Произошла непредвиденная ошибка. Повторите попытку.",
            "dxDataGrid-aiAssistantInvalidResponseMessage": "Некорректный ответ от службы ИИ. Повторите попытку.",
            "dxDataGrid-aiAssistantClearButtonText": "Очистить",
            "dxDataGrid-aiAssistantRegenerateButtonText": "Создать заново",
            "dxDataGrid-aiAssistantAbortConfirmText": "Закрытие чата помощника ИИ прервёт текущие запросы. Закрыть чат?",
            "dxDataGrid-aiAChatEmptyViewMessage": "Чат пуст",
            "dxDataGrid-aiChatEmptyViewPrompt": "Помощник ИИ готов ответить на ваши вопросы.",
